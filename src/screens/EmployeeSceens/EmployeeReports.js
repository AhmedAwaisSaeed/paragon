...
<View>
  <ScrollView  keyboardShouldPersistTaps={"handled"}>
            ...
            <View style={{flex:1,justifyContent:"center"}}><Text style={styles.topBarText}>Reports</Text></View>
          ...
          {/* {
      this.state.showIndicator ? <View style={{flex:1}}><View style={styles.loading}><ActivityIndicator size="large" color="blue" /></View></View> :null
    } */}
