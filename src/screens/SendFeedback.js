  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <MyTopBarTwo  screenText="Send Feedback" showLeftIcon= {true} showRightIcon={false} idComponent={this.props.componentId} />
        </View>
      ...
      <View style={styles.submitButton}>
        <Text style={styles.submitButtonText}>Paragon@info.com</Text>
      </View>
