...
export default class Dashboard extends Component{
  ...
  tab_pressed=async (unselectedTabIndex,selectedTabIndex)=>{
    ...
    if(item.staff==false && selectedTabIndex==2)
    {
      Alert.alert("Sorry you don't have permission to access this page");
      this.hidethisScreen(unselectedTabIndex);

    }
    else if(item.reports==false && selectedTabIndex==3)
    {
      Alert.alert("Sorry you don't have permission to access this page");

    }
    else if (item.projects==false && selectedTabIndex==1)
    {
      Alert.alert("Sorry you don't have permission to access this page");
      this.hidethisScreen(unselectedTabIndex);
