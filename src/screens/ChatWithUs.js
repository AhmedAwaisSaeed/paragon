...
export default class ChatWithUs extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
     ...
     <SafeAreaView>
        ...
        <MyTopBarTwo  screenText="Chat With Us" showLeftIcon= {true} showRightIcon={false} idComponent={this.props.componentId} />
        </View>
