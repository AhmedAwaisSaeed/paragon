...
export default class InactiveManagers extends Component{
...
<MyTopBarTwo  screenText="Inactive Managers" showLeftIcon= {true} showRightIcon={false} idComponent={this.props.componentId} />

</View>
<View style={styles.topBarLine} />
{/* End Top Bar */}
<ScrollView style={{flex:1}} keyboardShouldPersistTaps={"handled"}>
{console.log("Response in Inactive Manager= ",this.props.response)}
