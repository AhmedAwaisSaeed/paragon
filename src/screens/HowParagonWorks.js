...
export default class HowParagonWorks extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
     ...
     <SafeAreaView>
        ...
        <MyTopBarTwo  screenText="How Paragon Works" showLeftIcon= {true} showRightIcon={false} idComponent={this.props.componentId} />
        </View>
