...
async _getRoot(key) {
  ...
  // async componentWillMount(){
    // this.goToBottomScreen("AccountScreenId",4);

    console.log("Accounts will");

    console.log("In Accounts Screen");
      ...
      if(responseJson.code==200)
       {
          ...
          this.setState({showIndicator:false});
              ...
              console.log("response in Accounts",responseJson);
              ...
              console.log("response in accounts=",token);
        //  return;
       }
       else
       {
  ...
  hit_logoutCall =async()=>{
   ...
   var root =await this._getRoot("root");
        ...
        if(responseJson.code==200)
         {
          ...
          //  AsyncStorage.clear();
            ...
            // Navigation.popTo(root);
            // Navigation.popToRoot(root);
            // Navigation.popToRoot(root, { bottomTabs: { currentTabIndex: 2 }})
            // Navigation.dismissAllModals();
            //  Navigation.popToRoot(root);

            // Navigation.popToRoot(root, { bottomTabs: { currentTabIndex: 4 }})
        
            // Navigation.dismissAllModals();

            //  this.goToNexctScreen("Login","");
            // this.goToBottomScreen("WelcomeScreenId",0);
  ...
  EditProfileCall=() =>{
    ...
    this.goToEditProfile("AdminEditProfile",this.state.AdminProfile,this.state.AdminLogoPath,this.state.AdminEmail);
  }
